...
$author=$_POST['author'];
$author=$_POST['quantity'];
$isbn=$_POST['isbn'];
$price=$_POST['price'];
$sql="INSERT INTO  tblbooks(BookName,CatId,AuthorId,Quantity,ISBNNumber,BookPrice) VALUES(:bookname,:category,:author,:quantity,:isbn,:price)";
$query = $dbh->prepare($sql);
$query->bindParam(':bookname',$bookname,PDO::PARAM_STR);
$query->bindParam(':category',$category,PDO::PARAM_STR);
$query->bindParam(':author',$author,PDO::PARAM_STR);
$query->bindParam(':quantity',$isbn,PDO::PARAM_STR);
